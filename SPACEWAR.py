...
def initGame():
    ...
    fighter = pygame.image.load('images/ship.png')
    missile = pygame.image.load('images/missile1.png')
    explosion = pygame.image.load('images/boom.png')
    ...
    rocks.append((0, pygame.image.load('images/rock1.png')))
    rocks.append((1, pygame.image.load('images/rock2.png')))
